...
const NAMap = () => (
  <svg viewBox="0 0 600 400" fill="none" className="w-full h-full">
    <defs>
      ...
      <linearGradient id="na-line" x1="0%" y1="0%" x2="100%" y2="0%">
    ...
    {[80, 140, 200, 260, 320].map(y => (
      <line key={`h${y}`} x1="50" y1={y} x2="550" y2={y} stroke="#60a5fa" strokeOpacity="0.06" strokeWidth="0.5" />
    ))}
    {[120, 200, 280, 360, 440].map(x => (
      <line key={`v${x}`} x1={x} y1="40" x2={x} y2="360" stroke="#60a5fa" strokeOpacity="0.06" strokeWidth="0.5" />
    ))}
    ...
    <path d="M180,45 L200,40 L225,38 L250,42 L275,38 L300,35 L330,40 L355,50 L375,55 L395,65 L410,80 L420,100 L425,125 L422,150 L415,170 L405,185 L395,195 L380,205 L365,215 L350,230 L335,245 L325,255 L310,265 L295,270 L280,275 L265,280 L250,278 L235,275 L220,280 L205,285 L190,290 L175,285 L160,275 L150,260 L142,245 L135,225 L130,205 L125,185 L120,165 L118,145 L115,125 L118,105 L122,85 L130,70 L145,55 L165,48 Z"
      fill="#60a5fa" fillOpacity="0.08" stroke="#60a5fa" strokeOpacity="0.2" strokeWidth="1" />
    {/* Alaska */}
    <path d="M100,55 L120,48 L140,45 L155,50 L148,58 L130,62 L112,60 Z"
      fill="#60a5fa" fillOpacity="0.06" stroke="#60a5fa" strokeOpacity="0.15" strokeWidth="0.8" />
    ...
    <path d="M190,290 L200,300 L215,310 L230,315 L245,318 L255,325 L250,335 L240,340 L225,338 L210,330 L195,320 L185,305 L182,295 Z"
      fill="#60a5fa" fillOpacity="0.05" stroke="#60a5fa" strokeOpacity="0.12" strokeWidth="0.8" />
    ...
    {[
      ...
      <g key={`dot${i}`}>
        <circle cx={cx} cy={cy} r="1.5" fill="#60a5fa" fillOpacity="0.4" />
        {i < 5 && <circle cx={cx} cy={cy} r="4" fill="none" stroke="#60a5fa" strokeOpacity="0.15" strokeWidth="0.5" />}
      </g>
    ))}
    {/* Connection lines between hubs */}
    <path d="M280,120 L310,135 L350,110 L395,145" stroke="#60a5fa" strokeOpacity="0.1" strokeWidth="0.5" fill="none" />
    <path d="M260,155 L290,170 L340,165 L370,180" stroke="#60a5fa" strokeOpacity="0.08" strokeWidth="0.5" fill="none" />
  </svg>
);
...
const APACMap = () => (
  <svg viewBox="0 0 600 400" fill="none" className="w-full h-full">
    ...
    {/* Grid */}
    {[80, 140, 200, 260, 320].map(y => (
      <line key={`h${y}`} x1="30" y1={y} x2="570" y2={y} stroke="#34d399" strokeOpacity="0.06" strokeWidth="0.5" />
    ))}
    {[100, 180, 260, 340, 420, 500].map(x => (
      <line key={`v${x}`} x1={x} y1="40" x2={x} y2="360" stroke="#34d399" strokeOpacity="0.06" strokeWidth="0.5" />
    ))}
    ...
    <path d="M120,50 L160,42 L200,45 L240,40 L280,48 L310,60 L330,80 L340,105 L338,130 L330,155 L315,170 L300,180 L280,185 L260,190 L240,195 L220,192 L200,185 L185,175 L170,160 L155,140 L140,120 L130,100 L122,80 L118,65 Z"
      fill="#34d399" fillOpacity="0.08" stroke="#34d399" strokeOpacity="0.2" strokeWidth="1" />
    {/* Japan */}
    <path d="M350,75 L360,70 L370,78 L375,95 L372,115 L365,130 L355,125 L348,110 L345,90 Z"
      fill="#34d399" fillOpacity="0.07" stroke="#34d399" strokeOpacity="0.18" strokeWidth="0.8" />
    {/* Southeast Asia */}
    <path d="M200,210 L230,205 L260,210 L290,220 L310,235 L305,255 L290,265 L270,270 L250,268 L230,260 L215,245 L205,230 Z"
      fill="#34d399" fillOpacity="0.06" stroke="#34d399" strokeOpacity="0.15" strokeWidth="0.8" />
    {/* India */}
    ...
    <path d="M340,280 L370,270 L400,275 L430,285 L450,300 L455,320 L445,340 L425,350 L400,352 L375,345 L355,330 L345,310 L340,295 Z"
      fill="#34d399" fillOpacity="0.05" stroke="#34d399" strokeOpacity="0.12" strokeWidth="0.8" />
    {/* Indonesia archipelago */}
    <path d="M250,280 L270,278 L290,282 L310,285 L320,290 L310,295 L290,292 L270,290 L255,288 Z"
      fill="#34d399" fillOpacity="0.04" stroke="#34d399" strokeOpacity="0.1" strokeWidth="0.5" />
    {/* City dots */}
    {[
      ...
      <g key={`dot${i}`}>
        <circle cx={cx} cy={cy} r="1.5" fill="#34d399" fillOpacity="0.4" />
        {i < 6 && <circle cx={cx} cy={cy} r="4" fill="none" stroke="#34d399" strokeOpacity="0.15" strokeWidth="0.5" />}
      </g>
    ))}
    {/* Connection lines */}
    <path d="M260,80 L300,95 L355,85" stroke="#34d399" strokeOpacity="0.1" strokeWidth="0.5" fill="none" />
    <path d="M150,180 L200,160 L250,195 L280,240" stroke="#34d399" strokeOpacity="0.08" strokeWidth="0.5" fill="none" />
  </svg>
);
...
const EMEAMap = () => (
  <svg viewBox="0 0 600 400" fill="none" className="w-full h-full">
    ...
    {/* Grid */}
    {[80, 140, 200, 260, 320].map(y => (
      <line key={`h${y}`} x1="30" y1={y} x2="570" y2={y} stroke="#fbbf24" strokeOpacity="0.06" strokeWidth="0.5" />
    ))}
    {[100, 180, 260, 340, 420, 500].map(x => (
      <line key={`v${x}`} x1={x} y1="40" x2={x} y2="360" stroke="#fbbf24" strokeOpacity="0.06" strokeWidth="0.5" />
    ))}
    {/* Europe */}
    <path d="M160,40 L190,35 L220,38 L250,35 L280,40 L310,38 L335,45 L355,55 L365,70 L360,90 L350,105 L335,115 L315,120 L295,118 L275,122 L255,128 L235,125 L215,130 L195,128 L175,120 L160,108 L150,92 L148,72 L152,55 Z"
      fill="#fbbf24" fillOpacity="0.08" stroke="#fbbf24" strokeOpacity="0.2" strokeWidth="1" />
    {/* UK & Ireland */}
    <path d="M140,55 L155,50 L165,58 L162,72 L155,80 L145,78 L138,68 Z"
      fill="#fbbf24" fillOpacity="0.07" stroke="#fbbf24" strokeOpacity="0.18" strokeWidth="0.8" />
    {/* Scandinavia */}
    <path d="M260,20 L275,18 L290,25 L295,40 L288,55 L275,50 L265,40 L258,30 Z"
      fill="#fbbf24" fillOpacity="0.06" stroke="#fbbf24" strokeOpacity="0.15" strokeWidth="0.8" />
    {/* Middle East */}
    ...
    <path d="M200,145 L230,140 L260,145 L280,155 L295,170 L305,190 L310,215 L308,240 L300,265 L288,285 L270,300 L250,310 L230,315 L210,310 L195,300 L182,280 L175,260 L172,235 L175,210 L180,190 L185,170 L190,155 Z"
      fill="#fbbf24" fillOpacity="0.05" stroke="#fbbf24" strokeOpacity="0.12" strokeWidth="0.8" />
    {/* City dots */}
    {[
      ...
      <g key={`dot${i}`}>
        <circle cx={cx} cy={cy} r="1.5" fill="#fbbf24" fillOpacity="0.4" />
        {i < 6 && <circle cx={cx} cy={cy} r="4" fill="none" stroke="#fbbf24" strokeOpacity="0.15" strokeWidth="0.5" />}
      </g>
    ))}
    {/* Connection lines */}
    <path d="M155,65 L200,70 L250,60 L300,55 L340,65" stroke="#fbbf24" strokeOpacity="0.1" strokeWidth="0.5" fill="none" />
    <path d="M280,90 L320,100 L400,155 L420,175" stroke="#fbbf24" strokeOpacity="0.08" strokeWidth="0.5" fill="none" />
  </svg>
);
...
const ChinaMap = () => (
  <svg viewBox="0 0 600 400" fill="none" className="w-full h-full">
    ...
    {/* Grid */}
    {[80, 140, 200, 260, 320].map(y => (
      <line key={`h${y}`} x1="50" y1={y} x2="550" y2={y} stroke="#f87171" strokeOpacity="0.06" strokeWidth="0.5" />
    ))}
    {[120, 200, 280, 360, 440].map(x => (
      <line key={`v${x}`} x1={x} y1="40" x2={x} y2="360" stroke="#f87171" strokeOpacity="0.06" strokeWidth="0.5" />
    ))}
    ...
    <path d="M140,55 L175,45 L215,48 L255,42 L295,50 L330,60 L360,78 L385,100 L400,125 L408,155 L410,185 L405,210 L395,235 L380,255 L360,270 L340,280 L315,288 L290,292 L265,290 L240,285 L218,275 L198,260 L180,242 L165,220 L152,198 L142,175 L135,150 L130,125 L132,100 L136,78 Z"
      fill="#f87171" fillOpacity="0.08" stroke="#f87171" strokeOpacity="0.2" strokeWidth="1" />
    {/* Xinjiang region */}
    <path d="M100,80 L130,70 L155,75 L165,90 L160,110 L145,120 L125,118 L108,108 L98,95 Z"
      fill="#f87171" fillOpacity="0.05" stroke="#f87171" strokeOpacity="0.12" strokeWidth="0.8" />
    {/* Tibet region */}
    <path d="M105,130 L135,125 L160,135 L170,155 L165,175 L148,185 L125,180 L110,168 L100,150 Z"
      fill="#f87171" fillOpacity="0.04" stroke="#f87171" strokeOpacity="0.1" strokeWidth="0.8" />
    {/* Taiwan */}
    <path d="M420,215 L428,210 L435,218 L432,232 L425,238 L418,230 Z"
      fill="#f87171" fillOpacity="0.07" stroke="#f87171" strokeOpacity="0.18" strokeWidth="0.8" />
    {/* Hainan */}
    ...
    {[
      ...
      <g key={`dot${i}`}>
        <circle cx={cx} cy={cy} r="1.5" fill="#f87171" fillOpacity="0.4" />
        {i < 5 && <circle cx={cx} cy={cy} r="4" fill="none" stroke="#f87171" strokeOpacity="0.15" strokeWidth="0.5" />}
      </g>
    ))}
    {/* Connection lines - data center corridors */}
    <path d="M380,135 L395,165 L360,195 L340,230 L310,255" stroke="#f87171" strokeOpacity="0.1" strokeWidth="0.5" fill="none" />
    <path d="M270,160 L300,140 L350,120" stroke="#f87171" strokeOpacity="0.08" strokeWidth="0.5" fill="none" />
    <path d="M220,180 L250,200 L280,210 L320,170" stroke="#f87171" strokeOpacity="0.08" strokeWidth="0.5" fill="none" />
  </svg>
);
...
export default function RegionMapBg({ region }: { region: RegionKey }) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {/* Full-bleed background with subtle animation feel */}
      <div className="absolute inset-0 flex items-center justify-end">
        <div className="w-[80%] h-full opacity-60 translate-x-[10%]">
          <MapComponent />
        </div>
      </div>
